...
<body>
	...
	<section>
		<div class="container">
			<div class="row roomy-20 m-top-70 no-select">
					...
					<div class="row" style="padding: 40px; border: 1px solid #b4b4b4">
							...
							<div style="height: 110px;">
								<div>
									...
									<div style="float: left; width: 35%;">
										<input type='checkbox' name='경력' value="전체" checked>
										전체<br> <input type='checkbox' name='경력' value="신입">
										신입<br> <input type='checkbox' name='경력' value="경력">
										경력 ( <input type='text' size="10">년 ~ <input
											type='text' size="10">년) <br> <input
											type='checkbox' name='경력' value="관계없음"> 관계없음
									</div>
								</div>
								<div>
									<div style="float: left; width: 15%; font-weight: bold;">
										학력</div>
									<div style="float: left; width: 35%;">
										<input type='checkbox' name='학력' value="전체" checked>
										전체 <input type='checkbox' name='학력' value="중졸이하"> 중졸이하
										<input type='checkbox' name='학력' value="고졸"> 고졸<br>
										<input type='checkbox' name='학력' value="대졸(2~3년)">
										대졸(2~3년) <input type='checkbox' name='학력' value="대졸(4년)">
										대졸(4년) <input type='checkbox' name='학력' value="석사"> 석사<br>
										<input type='checkbox' name='학력' value="박사"> 박사 <input
						...
						<div class="m-bottom-20">
							<div style="float: left; width: 15%; font-weight: bold;">
								기업형태</div>
							<div>
								<input type='checkbox' name='기업형태' value="전체" checked>
								전체 <input type='checkbox' name='기업형태' value="대기업"> 대기업 <input
