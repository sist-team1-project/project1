		...
		<section>
				...
				<div class="container container-pad">
						...
						<div class="row m-top-60">
								...
								<div class="row row-border">
										...
										<div class="row bggrey">
												<div class="col-md-4 Tcenter title-deco height-45">
														<strong>경력조건</strong>
												</div>
												<div class="col-md-4 Tcenter title-deco height-45">
														<strong>학력</strong>
										...
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_we }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_education }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_workplace }</td>
														</tr>
												</table>
										</div>
								</div>
						...
						<div class="row m-top-60">
								...
								<div class="row row-border">
										...
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-45">${ad.ad_wage }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-45">${ad.ad_workhours }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-4">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-45">${ad.ad_worktype }</td>
														</tr>
												</table>
										</div>
								</div>
						...
						<div class="row m-top-60">
								...
								<div class="row row-border">
										<div class="row bggrey">
												<div class="col-md-3 Tcenter title-deco height-45">
														<strong>우대전공</strong>
												</div>
												<div class="col-md-3 Tcenter title-deco height-45">
														<strong>우대자격증</strong>
										...
										<div class="row col-md-3">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_major }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-3">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_qualification }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-3">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_language }</td>
														</tr>
												</table>
										</div>
										<div class="row col-md-3">
												<table class="top-table">
														<tr>
																<td class="Tcenter height-60">${ad.ad_end }</td>
														</tr>
												</table>
										</div>
								</div>
