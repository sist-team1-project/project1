    ...
    <table class="table">
      <tr>
       ...
       <td width=85% class="inline">
         <input type=text name=u_id id="join_id" size=22 class="input-sm" placeholder="아이디 중복체크를 해주세요."readonly >
      ...
      <tr>
       ...
       <td width=85% class="inline">
         <input type=password name=u_password id=join_pwd size=22 class="input-sm" placeholder="비밀번호를 입력하세요.">
         &nbsp;&nbsp;재입력:
      ...
      <tr>
       ...
       <td width=85%>
         <input type=text name=u_name id=name size=22 class="input-sm" placeholder="이름을 입력하세요.">
       </td>
      </tr>
      <tr>
       <td class="text-right" width=15%>생년월일</td>
       <td width=85%>
         <input type=date size=22 name=u_birthday class="input-sm" id="day">
       </td>
      </tr>
      <tr>
      <tr>
       ...
       <td width=85% class="inline">
         <input type=radio value="남자" name=u_gender checked="checked">남자
         <input type=radio value="남자" name=u_gender>여자
       </td>
      </tr>
      <tr>
       <td class="text-right" width=15%>이메일</td>
       <td width=85%>
         <input type=text name=u_email id=email size=50 class="input-sm" placeholder="이메일 주소를 입력하세요.">
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td width=85% class="inline">
       <select name=u_question id=question>
      ...
      <br><input type="text" name=u_answer id=answer size=38 placeholder="답변을 입력하세요.">
       </tr>
      <tr>
