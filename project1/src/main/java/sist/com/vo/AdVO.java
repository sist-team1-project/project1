...
public class AdVO {
    ...
    private String ad_we;
    private String ad_education;
    private String ad_qualification;
    private String ad_language;
    private String ad_major;
    private String ad_wage;
    private String ad_workhours;
    private String ad_worktype;
    private String ad_workplace;
    private String ad_end;
    private int ad_visits;
    ...
    public int getAd_visits() {
        return ad_visits;
    }

    public void setAd_visits(int ad_visits) {
        this.ad_visits = ad_visits;
    }
}